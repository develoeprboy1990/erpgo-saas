    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('register.store', ['plan' => $plan]) }}" class='needs-validation' novalidate>
            ...
            <div class="">
				...
				<!--- Domain --->			
				<div class="form-group mb-3">
                    <label for="subdomain" class="form-label">{{ __('Domain') }}</label>
                    <input id="subdomain" type="text" class="form-control @error('subdomain') is-invalid @enderror"
                        ...
                        placeholder="{{ __('Company Name') }}" required="required">
                    @error('subdomain')
				...
				<div class="form-group mb-3">
                    ...
                    <input id="companyname" type="text" class="form-control @error('companyname') is-invalid @enderror"
                        name="companyname" value="{{ old('companyname') }}" autocomplete="companyname" autofocus
                        placeholder="{{ __('Company Name') }}" required="required">
                    @error('companyname')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
